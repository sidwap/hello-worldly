...
const CREDIT_HREF = "https://linktr.ee/";
const CREDIT_HTML = `Telegram Web Drive Made with <span class="heart">&hearts;</span> by <a class="credit-name" href="${CREDIT_HREF}" target="_blank" rel="noopener">Sid</a>`;
